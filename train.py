...
def main(cfg):
    ...
    dataset_train = WaymoDataset(cfg.train.tfrecords, cfg.train.idxs)
    dataset_valid = WaymoDataset(cfg.valid.tfrecords, cfg.valid.idxs)
    ...
    model = SceneTransformer(device, cfg.model.in_feat_dim, cfg.model.in_deynamic_rg_dim, cfg.model.in_static_rg_dim,
                                cfg.model.time_steps, cfg.model.feature_dim, cfg.model.head_num, cfg.model.k, cfg.model.F)

    trainer = pl.Trainer(max_epochs=cfg.max_epochs, gpus=cfg.device)
